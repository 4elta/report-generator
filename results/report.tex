...
\begin{table}[h!]
  ...
  \begin{tabular}{llr}
    ...
    \hline
          ...
          Class B & $\vert$ & 1 \\
        \hline
    \textbf{Total} & $\vert\vert\vert$ & \textbf{3}
  \end{tabular}
\end{table}

Vulnerabilities with severity scores between 6.0 and 9.8 (on a scale from 0--10) have been found.
...
\label{sec:results}
  ...
  \begin{table}[h]
    ...
    \caption{Issues.}    \begin{tabular}{ll}
      ...
      \hline
              \hyperref[issue.md]{Lorem Ipsum Dolor sit Amet} & \minimalseveritygauge[0.2]{9.8} 9.8 \\
              \hyperref[issue2.md]{Aenean Gravida Pulvinar Lacus} & \minimalseveritygauge[0.2]{6.0} 6.0 \\
          \end{tabular}
  \end{table}
  \begin{table}[h]
    \centering
    \caption{Issues of component ``EXAMPLE''.}    \begin{tabular}{ll}
      \textbf{Vulnerability} & \textbf{Severity} \\
      \hline
              \hyperref[1:EXAMPLE:issue.md]{[EXAMPLE] Lorem Ipsum Dolor sit Amet} & \minimalseveritygauge[0.2]{6.5} 6.5 \\
          \end{tabular}
  \end{table}
