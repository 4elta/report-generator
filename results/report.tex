...
Ut quisquam et a cupiditate (see Figure \ref{fig:0-None-issue-issue.png}).
...
\end{itemize}
    ...
    \begin{center}
      \severitygauge{9.8}{9.8 (critical)}
...
\end{itemize}
        ...
        \caption{Vero repellat sed vero facere error ducimus et.}
        \label{fig:0-None-issue-issue.png}
      \end{figure}
...
\end{itemize}
  ...
  % specify directory/directories where LaTeX should look for images
  \graphicspath{ {report/issues/1 - EXAMPLE} }

  % loop over each of the group's issues
      \clearpage
    \subsection{[EXAMPLE] Lorem Ipsum Dolor sit Amet
}
    \label{1-EXAMPLE-issue}
...
\end{itemize}
          ...
          \begin{figure}[p]
        \centering
        \includegraphics[width=\textwidth]{issue.jpg}
        \caption{Vero repellat sed vero facere error ducimus et.}
        \label{fig:1-EXAMPLE-issue-issue.jpg}
      \end{figure}
